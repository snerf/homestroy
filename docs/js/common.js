...
var currp = 1;
    ...
    $("#catalog-menu-description-but").die().live("click",function(){
        var a = $(this);

        if($("#catalog-menu-description").hasClass("close")){
            $("#catalog-menu-description").removeClass("close").addClass("open");
            $("#catalog-menu-description-but").html("&raquo;&raquo;&raquo;&nbsp;скрыть");
        }
        else{
            $("#catalog-menu-description").removeClass("open").addClass("close");
            $("#catalog-menu-description-but").html("&raquo;&raquo;&raquo;&nbsp;читать далее");
        }
